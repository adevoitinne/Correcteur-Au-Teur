...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/GenreFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/InterestFixtures.php';
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/OfferFixtures.php';
        ...
        $a->addFixtures([['fixture' => new \App\DataFixtures\GenreFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\InterestFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\MemberFixtures(($container->privates['security.user_password_hasher'] ?? $container->load('getSecurity_UserPasswordHasherService'))), 'groups' => []], ['fixture' => new \App\DataFixtures\OfferFixtures(), 'groups' => []]]);
