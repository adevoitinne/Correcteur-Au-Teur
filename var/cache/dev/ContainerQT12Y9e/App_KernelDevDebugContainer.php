...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Admin\\MemberController' => 'getMemberControllerService',
            'App\\Controller\\ContactController' => 'getContactController2Service',
            'App\\Controller\\FunctioningController' => 'getFunctioningControllerService',
            'App\\Controller\\HomepageController' => 'getHomepageController2Service',
            'App\\Controller\\LegalSupportController' => 'getLegalSupportControllerService',
            'App\\Controller\\Profile\\HomepageController' => 'getHomepageController3Service',
            'App\\Controller\\Profile\\MyOfferController' => 'getMyOfferControllerService',
            'App\\Controller\\Profile\\MyProfileController' => 'getMyProfileControllerService',
            'App\\Controller\\Profile\\OfferController' => 'getOfferControllerService',
            ...
            'App\\Controller\\TechnicalSupportController' => 'getTechnicalSupportControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('lB2URb5WXb', 0, ($container->targetDir.''.'/pools/app'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AY8inRa6an', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('T-BJquZpR6', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JbL6dJn+IA', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\Admin\\ContactController', 'App\\Controller\\Admin\\HomepageController', 'App\\Controller\\Admin\\MemberController', 'App\\Controller\\ContactController', 'App\\Controller\\FunctioningController', 'App\\Controller\\HomepageController', 'App\\Controller\\LegalSupportController', 'App\\Controller\\Profile\\HomepageController', 'App\\Controller\\Profile\\MyOfferController', 'App\\Controller\\Profile\\MyProfileController', 'App\\Controller\\Profile\\OfferController', 'App\\Controller\\RegistrationController', 'App\\Controller\\SecurityController', 'App\\Controller\\TechnicalSupportController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['asset_mapper.repository'] = new \Symfony\Component\AssetMapper\AssetMapperRepository([(\dirname(__DIR__, 4).'/vendor/symfony/ux-turbo/src/DependencyInjection/../../assets/dist') => '@symfony/ux-turbo', (\dirname(__DIR__, 4).'/vendor/symfony/ux-toggle-password/src/DependencyInjection/../../assets/dist') => '@symfony/ux-toggle-password', (\dirname(__DIR__, 4).'/vendor/symfony/stimulus-bundle/src/DependencyInjection/../../assets/dist') => '@symfony/stimulus-bundle', 'assets/' => ''], \dirname(__DIR__, 4), ['#^(?=[^\\.]).*\\.d\\.ts$#', '#^(?=[^\\.]).*.*/(?=[^\\.])controllers\\.json$#'], true, true);
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PIMFE9Yl2n', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OgZM5XZTv+', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Y0kOMVzpEv', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WnS2Gkk83O', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('80byW92Wta', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container))));
    }
    ...
    protected static function getTwigService($container)
    {
        ...
        $a->addPath((\dirname(__DIR__, 4).'/vendor/symfony/security-bundle/Resources/views'), '!Security');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/symfony/ux-toggle-password/templates'), 'TogglePassword');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/symfony/ux-toggle-password/templates'), '!TogglePassword');
        ...
        return [
            ...
            'kernel.bundles_metadata' => [
                ...
                'TogglePasswordBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/symfony/ux-toggle-password'),
            ...
            'twig.form.resources' => [
                ...
                1 => '@TogglePassword/form_theme.html.twig',
            ],
