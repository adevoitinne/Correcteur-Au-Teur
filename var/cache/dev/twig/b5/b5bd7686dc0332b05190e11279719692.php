...
class __TwigTemplate_6562308791865b10ebb8edc46ede64f5 extends Template
{
    ...
    <main aria-label=\"contenu principal\" id=\"main\">
        ...
        yield "\" alt=\"diagramme de fonctionnement de Correct-Au-Teur\">
            ...
            <div class=\"bottom-band text-center\">
                <p class=\"fw-bold h4\">Créez vite votre Profil Membre <a class=\"h4 simple-link\" href=\"";
        // line 22
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("registration.register");
        yield "\">ici</a>, pour faire partie de l'Aventure <strong class=\"c-a-t h3\">Correct-Au-Teur</strong></p>        
            </div>
        </div>
    </main>
";
    ...
    {
        return array (  102 => 22,  91 => 14,  85 => 11,  63 => 3,  40 => 1,);
    }
...
{% block body%} 
    <main aria-label=\"contenu principal\" id=\"main\">
        <div class=\"explanation\">
            ...
            <div class=\"bottom-band text-center\">
                <p class=\"fw-bold h4\">Créez vite votre Profil Membre <a class=\"h4 simple-link\" href=\"{{ url('registration.register') }}\">ici</a>, pour faire partie de l'Aventure <strong class=\"c-a-t h3\">Correct-Au-Teur</strong></p>        
            </div>
        </div>
    </main>
