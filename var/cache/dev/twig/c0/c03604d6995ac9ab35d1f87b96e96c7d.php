...
class __TwigTemplate_cee7cee9babbfd4dd6ef4f3d967ba6d7 extends Template
{
...
\t\t\t\t\t\t\t<td>";
        // line 16
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["member"]) || array_key_exists("member", $context) ? $context["member"] : (function () { throw new RuntimeError('Variable "member" does not exist.', 16, $this->source); })()), "email", [], "any", false, false, false, 16), "html", null, true);
        yield "</td>
\t\t\t\t\t\t\t<td></td>
\t\t\t\t\t\t</tr>
\t\t\t\t\t</table>
...
";
    ...
    {
        return array (  102 => 22,  93 => 16,  83 => 8,  81 => 7,  76 => 4,  63 => 3,  40 => 1,);
    }
...
", "admin/member/detail.html.twig", "/Volumes/T7 Shield/dossier-de-travail/templates/admin/member/detail.html.twig");
    }
}
