...
class __TwigTemplate_3cba02eb7e2876589c1a281047fd4014 extends Template
{
    ...
    <div class=\"container-fluid\">
      ...
      <div class=\"row flex-sm-column flex-md-row justify-content-around\">
        <section aria-label=\"texte d'explication\" class=\"col-sm-12 col-md-8 section\">
          ...
          <p class=\"h4 py-2 paragraph\">
              ...
              Cliquez <a class=\"h4 simple-link\" href=\"";
        // line 20
      ...
      <div class=\"row flex-sm-column flex-md-row-reverse justify-content-around\">
        <section aria-label=\"texte d'explication\" class=\"col-sm-12 col-md-8 section\">
          ...
          <p class=\"h4 py-2 paragraph\">
            Concernant la protection juridique de votre œuvre, pas de crainte à avoir. Nous avons pensé à tout, aller en page <a class=\"h4 simple-link\" href=\"";
        // line 36
        ...
        yield "\">Accompagnement Juridique</a> pour en savoir plus.
          ...
          <p class=\"h4 py-2 paragraph\">
            Concernant l'aspect technique, nous vous recommandons la bonne méthode pour la correction de votre manuscrit et les échanges avec le Correcteur. Aller en page <a class=\"h4 simple-link\" href=\"";
        // line 39
        ...
        yield "\">Accompagnement Technique</a>  pour en savoir plus.
          ...
          <p class=\"h4 py-2 paragraph\">
            Créez vite votre Profil Membre, <a class=\"h4 simple-link\" href=\"";
        // line 42
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("registration.register");
        yield "\">ici</a>, pour faire partie de l'Aventure <strong class=\"c-a-t h3\">Correct-Au-Teur</strong>.
          </p>
        </section>
...
";
    ...
    {
        return array (  135 => 46,  128 => 42,  122 => 39,  116 => 36,  104 => 27,  94 => 20,  63 => 3,  40 => 1,);
    }
    ...
    <div class=\"container-fluid\">
      ...
      <div class=\"row flex-sm-column flex-md-row justify-content-around\">
        <section aria-label=\"texte d'explication\" class=\"col-sm-12 col-md-8 section\">
          ...
          <p class=\"h4 py-2 paragraph\">
              Nous mettons en relation des auteurs pour relire et corriger, gratuitement, les travaux d'autres auteurs.
              Cliquez <a class=\"h4 simple-link\" href=\"{{url('functioning.index')}}\">ici</a> pour voir comment cela fonctionne.
          </p>
          <p class=\"h4 py-2 paragraph\">
              Votre manuscrit sera dans les mains d'un Auteur que vous aurez choisi selon son profil et vos échanges préalables.
          </p>
      ...
      <div class=\"row flex-sm-column flex-md-row-reverse justify-content-around\">
        <section aria-label=\"texte d'explication\" class=\"col-sm-12 col-md-8 section\">
          ...
          <p class=\"h4 py-2 paragraph\">
            Concernant la protection juridique de votre œuvre, pas de crainte à avoir. Nous avons pensé à tout, aller en page <a class=\"h4 simple-link\" href=\"{{url('legal-support.index')}}\">Accompagnement Juridique</a> pour en savoir plus.
          </p>
          <p class=\"h4 py-2 paragraph\">
            Concernant l'aspect technique, nous vous recommandons la bonne méthode pour la correction de votre manuscrit et les échanges avec le Correcteur. Aller en page <a class=\"h4 simple-link\" href=\"{{url('technical-support.index')}}\">Accompagnement Technique</a>  pour en savoir plus.
          </p>
          <p class=\"h4 py-2 paragraph\">
            Créez vite votre Profil Membre, <a class=\"h4 simple-link\" href=\"{{url('registration.register')}}\">ici</a>, pour faire partie de l'Aventure <strong class=\"c-a-t h3\">Correct-Au-Teur</strong>.
          </p>
        </section>
        <div class=\"col-sm-8 offset-sm-2 col-md-3 offset-md-0 mb-2 image-2\">
