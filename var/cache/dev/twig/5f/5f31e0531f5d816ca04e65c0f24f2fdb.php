...
class __TwigTemplate_c379d2a3adc1e1307d96e0bb9dd279c6 extends Template
{
    ...
    <div class=\"container-fluid px-md-4 row-gap-5\">
      <div class=\"row flex-md-row flex-sm-column align-items-center column-gap-3 py-3\">
      ...
      <div class=\"row flex-md-row-reverse flex-sm-column align-items-center column-gap-3 py-3\">
        ...
        <div class=\"col-md-8 col-sm-12 section\">
          <p class=\"paragraph align-self-center h4 py-2\">
            Tout d'abord lors de la création de son profil, chaque Auteur - Correcteur s'engage à respecter les CGS, consultables <a href=\"documents/cgs-v1.pdf\" class=\"h4 fst-italic fw-bold\">ici</a>, et surtout la propriété intellectuelle de l'Auteur concernant son manuscrit et ses idées originales.
          </p>
        </div>
      </div>
      <div class=\"row flex-md-row flex-sm-column column-gap-3 py-3\">
        <div class=\"col-md-2 col-sm-12\">
          <img src=\"";
        // line 28
        ...
        <div class=\"col-md-8 offset-md-1 col-sm-12 align-items-center section\">
          ...
          <p class=\"h4 py-2 paragraph\">  
            Le modèle d'engagement a été élaboré avec notre équipe juridique dans le but d'éviter des délits de plagiat ou vol de manuscrit et d'idées originales. Téléchargez-le ici : en version <a href=\"documents/accord-confidentialite.docx\" class=\"h4 fst-italic fw-bold\">Word</a> ou en version <a href=\"documents/accord-confidentialite.pdf\" class=\"h4 fst-italic fw-bold\">PDF</a>.
          </p>
        </div>
      </div>
    </div>
