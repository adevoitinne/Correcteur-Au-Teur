...
class __TwigTemplate_5690df42f2ee3e5a01c3fcd4710165eb extends Template
{
    ...
    <div class=\"container-fluid px-md-5 row-gap-md-5\">
      <div class=\"row flex-md-row flex-sm-column justify-content-center align-items-center column-gap-2 my-5\">
        <div class=\"col-12 text-center\">
          <p class=\"h4 py-2\">
            Le moyen le plus simple pour transmettre son manuscrit à votre correcteur et pour faciliter les échanges durant la phase de correction est le service Google Docs <a href=\"https://workspace.google.com/intl/fr-CA/products/docs/\" class=\"h4 fst-italic fw-bold\" aria-label=\"lien vers Google Docs\">ici</a>.
          </p>
        </div>
        <div class=\"col-12 text-center\">
        ...
        yield "\" alt=\"logo Google Docs\" class=\"GD-image\">
          </div>
        </div>
      </div>
      <div class=\"row flex-md-row flex-sm-column justify-content-center align-items-center column-gap-2 my-5\">
        <div class=\"col-md-4 col-sm-12 text-center\">
          ...
          <p class=\"h4 py-2\">
            En cas de besoin, n'hésitez pas à nous contacter <a href=\"#\" class=\"h4 fst-italic fw-bold\">ici</a> pour un support.
          </p>
        </div>
    ...
    <div class=\"container-fluid px-md-5 row-gap-md-5\">
      <div class=\"row flex-md-row flex-sm-column justify-content-center align-items-center column-gap-2 my-5\">
        ...
        <div class=\"col-12 text-center\">
          ...
          <div>
            <img src=\"{{ asset('img/logo-google-docs.png') }}\" alt=\"logo Google Docs\" class=\"GD-image\">
          </div>
        </div>
      </div>
      <div class=\"row flex-md-row flex-sm-column justify-content-center align-items-center column-gap-2 my-5\">
